...
#My samples are in the same order as the annotation so I will create some short names and add to annotation
adf$ShortNames <-c("dLAM1","dLAM2","dLAM3","Mono_M1","Mono_M2","Mono_M3")

# Create a factor for the macrophage type
cell_type <-c("dLAM", "dLAM", "dLAM", "Mono_M", "Mono_M", "Mono_M")
